---
layout: "post"
permalink: "my-frontend-reads"
image: "images/art-brushes.jpg"
---

Enjoy these articles and links to finely written content for the well-discerning web reader. 

I will add links when I feel the sun's light through the marine layer reflects an `opacity: 0.8` upon the southern wall of my neighbor's house. Which is rare in some cases, common in others.

## CSS/Sass
- [What the Flexbox?!](https://flexbox.io)
- [CSS Remynification](https://luisant.ca/remynifier)
...
## UX & Design
- [Great Alternatives to Hamburger Menus](https://uxplanet.org/great-alternatives-to-hamburger-menus-d4c76d9414dd)
- [Design Better Cards](https://uxdesign.cc/design-better-cards-c0d12ab581c4)
- [If your users are entering credit card numbers, then read this.](https://baymard.com/blog/credit-card-field-auto-format-spaces)
- [Animation in Design Systems](https://24ways.org/2016/animation-in-design-systems/)

---

## SVG
- [Creating pie charts w/ HTML & SVG](https://www.smashingmagazine.com/2015/07/designing-simple-pie-charts-with-css/)

---

## Productivity
- [Agile - Differences between Kanban & Scrum](https://www.atlassian.com/agile/kanban)
- [7 tricks to have very successful conference calls](https://christianheilmann.com/2017/01/10/7-tricks-to-have-very-successful-conference-calls/)
...
## Accessibility
- [Incremental Accessibility](https://the-pastry-box-project.net/charlotte-spencer/2015-july-31)
...
## Tooling / Git / NPM 
- [An Introduction to Git](https://blog.mwaysolutions.com/2015/07/16/a-short-introduction-to-git/) 
- [Never, ever expose your Git repository](https://thenextweb.com/insider/2015/07/27/a-simple-developer-error-is-exposing-private-information-on-thousands-of-websites/)
- [The State Of Advanced Website Builders](https://www.smashingmagazine.com/2017/06/advanced-website-builders/)
- [Searching external document files (like PDF or Word) with Elastic Search](https://blog.ambar.cloud/ingesting-documents-pdf-word-txt-etc-into-elasticsearch/)
...
## Security
- [Security basics of the web](http://www.integralist.co.uk/posts/security-basics.html)
...
- [The Myth of Long Hours](https://medium.com/@hcatlin/the-myth-of-long-hours-49a1f5072482)
